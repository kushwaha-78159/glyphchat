...
export default function Home() {
  ...
  return <div className="app-shell">
    <header className="topbar">
      <div className="brand-lockup"><AppLogo /><div><div className="brand-name">encrypt<span>chatboad</span></div><div className="brand-tagline">Private by design</div></div></div>
    ...
    <footer className="page-footer"><span>Encrypt Chatboad prototype</span><span><span className="footer-dot" /> Built for close friends</span><span>v0.1 · Glyph-26</span></footer>
  </div>;
}
